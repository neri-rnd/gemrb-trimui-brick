...
# TrimUI Brick: Added scrollbar focus for keyboard scrolling (L1/L2)
...
def OnJournalQuestSelect ():
	...
	# Focus scrollbar for keyboard scrolling
	sb = QuestDesc.GetScrollBar()
	if sb:
		sb.Focus()
...
def OpenLogWindow ():
	...
	LogWindow.Focus()
	# Focus scrollbar for keyboard scrolling (L1/L2 = up/down)
	sb = Text.GetScrollBar()
	if sb:
		sb.Focus()
